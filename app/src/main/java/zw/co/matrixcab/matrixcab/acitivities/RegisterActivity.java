...
public class RegisterActivity extends ActivityManagePermission implements GoogleApiClient.ConnectionCallbacks,
            ...
            public void onClick(View v) {
                if (validate()) {
                    if (CheckConnection.haveNetworkConnection(getApplicationContext())) {
                        ...
                        TastyToast.makeText(RegisterActivity.this, "network is not available", TastyToast.LENGTH_LONG, TastyToast.ERROR).show();
    ...
    public Boolean validate() {
        ...
        if (input_name.getText().toString().trim().equals("")) {
            input_name.setError("field is required");
            value = false;
        } else {
        ...
        if (input_mobile.getText().toString().trim().equals("")) {
            input_mobile.setError("mobile number is invalid");
            value = false;
        } else {
        ...
        if (!(input_password.length() >= 6)) {
            value = false;
            input_password.setError("minimum password length is 6 characters");
        } else {
        ...
        if (!input_password.getText().toString().trim().equals("") && (!input_confirmPassword.getText().toString().trim().equals(input_password.getText().toString().trim()))) {
            value = false;
            input_confirmPassword.setError("password didn't match");
        } else {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    if (response.has("status") && response.getString("status").equalsIgnoreCase("success")) {
                        ...
                        TastyToast.makeText(RegisterActivity.this, "success", TastyToast.LENGTH_LONG, TastyToast.SUCCESS).show();
                        ...
                        progressDialog.dismiss();
                        TastyToast.makeText(RegisterActivity.this, response.getString("data"), TastyToast.LENGTH_LONG, TastyToast.ERROR).show();

                    }
                } catch (JSONException e) {
                    progressDialog.dismiss();
                    TastyToast.makeText(RegisterActivity.this, "error occurred", TastyToast.LENGTH_LONG, TastyToast.ERROR).show();
