    ...
    public void onBindViewHolder(final Holder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString("pickup_location", list.get(holder.getAdapterPosition()).getPikup_location());
                bundle.putString("drop_location", list.get(holder.getAdapterPosition()).getDrop_locatoin());
                bundle.putString("payment_status", list.get(holder.getAdapterPosition()).getPayment_status());
                bundle.putString("driver_id", list.get(holder.getAdapterPosition()).getDriver_id());
                bundle.putString("payment_mode", list.get(holder.getAdapterPosition()).getPayment_mode());
