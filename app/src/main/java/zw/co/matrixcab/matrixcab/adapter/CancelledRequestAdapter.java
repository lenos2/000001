...
import zw.co.matrixcab.matrixcab.fragement.CancelledDetailFragment;
...
public class CancelledRequestAdapter extends RecyclerView.Adapter<CancelledRequestAdapter.Holder> {
    List<PendingRequestPojo> list;

    public CancelledRequestAdapter(List<PendingRequestPojo> list) {
        this.list = list;
    }

    @Override
    public Holder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new Holder(LayoutInflater.from(parent.getContext()).inflate(R.layout.cancelledrequest_item, parent, false));
    }
    ...
    public void onBindViewHolder(final Holder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString("request","cancelled");
                ...
                CancelledDetailFragment cancelledDetailFragment = new CancelledDetailFragment();
                cancelledDetailFragment.setArguments(bundle);
                ((HomeActivity) holder.itemView.getContext()).changeFragment(cancelledDetailFragment, "Passenger Information");
            }
        });
