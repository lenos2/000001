...
import zw.co.matrixcab.matrixcab.adapter.CancelledRequestAdapter;
...
public class CancelledFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.cancelled, container, false);
        bindView();
        if (CheckConnection.haveNetworkConnection(getActivity())) {
            getCancelledRequest(userid, "CANCELLED", key);
        } else {
    ...
    public void bindView() {
        ((HomeActivity) getActivity()).fontToTitleBar("Cancelled Request");
    ...
    public void getCancelledRequest(String id, String status, String key) {
                ...
                try {
                    ...
                    if (response.has("status") && response.getString("status").equalsIgnoreCase("success")) {
                        ...
                        if (response.has("data") && response.getJSONArray("data").length() == 0) {
                            ...
                            CancelledRequestAdapter cancelledRequestAdapter = new CancelledRequestAdapter(list);
                            recyclerView.setAdapter(cancelledRequestAdapter);
                            cancelledRequestAdapter.notifyDataSetChanged();
                        }
