...
public class ProfileFragment extends FragmentManagePermission implements GoogleApiClient.ConnectionCallbacks,
                                ...
                                .setOnImageSelectedListener(new TedBottomPicker.OnImageSelectedListener() {
                                    ...
                                    public void onImageSelected(Uri uri) {
                                       ...
                                       /* if (format.equalsIgnoreCase("jpg") || format.equalsIgnoreCase("png") || format.equalsIgnoreCase("gif") || format.equalsIgnoreCase("jpeg")) {
                                            ...
                                            TastyToast.makeText(getActivity(), "jpg,png or gif is only accepted", TastyToast.LENGTH_LONG, TastyToast.ERROR).show();
                                        }*/
                                    }
    ...
    public void bindView() {
        ((HomeActivity) getActivity()).fontToTitleBar("Profile");
        ...
        btn_change.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (CheckConnection.haveNetworkConnection(getActivity())) {
                    changepassword_dialog("CHANGE PASSWORD");
                } else {
                ...
                try {
                    if (response.has("status") && response.getString("status").equalsIgnoreCase("success")) {
                        ...
                        if (user != null) {
                            ...
                            TastyToast.makeText(getActivity(), "Profile Updated", TastyToast.LENGTH_LONG, TastyToast.SUCCESS).show();
                        }
                ...
                try {
                    if (response.has("status") && response.getString("status").equalsIgnoreCase("success")) {
                        ...
                        if (user != null) {
                            ...
                            TastyToast.makeText(getActivity(), "profile uploaded", TastyToast.LENGTH_LONG, TastyToast.SUCCESS).show();
                        }
                    } else {
                        progressBar.setVisibility(View.GONE);
                        TastyToast.makeText(getActivity(), response.getString("data"), TastyToast.LENGTH_LONG, TastyToast.ERROR).show();
                ...
                if (password.getText().toString().trim().equals("")) {
                    ...
                    if (user != null) {
                        ...
                        if (uid != null && !uid.equals("")) {
                            ...
                            TastyToast.makeText(getActivity(), "re-login and try agian", TastyToast.LENGTH_LONG, TastyToast.ERROR).show();
                        }
                    }
                } else {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    if (response.has("status") && response.getString("status").equalsIgnoreCase("success")) {
                        ...
                        dialog.cancel();
                        Log.e("success", response.toString());
                        TastyToast.makeText(getActivity(), "password Updated", TastyToast.LENGTH_LONG, TastyToast.SUCCESS).show();

                    } else {
                        progressDialog.cancel();
                        String error = response.getString("data");
                        TastyToast.makeText(getActivity(), error, TastyToast.LENGTH_LONG, TastyToast.ERROR).show();
